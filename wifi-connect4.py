"""
wifi-connect4.py  —  Evil-Twin Aware Edition (OUI-family aware)
=================================================================
Three layers of protection over the original, plus OUI-family recognition
to eliminate false positives on legitimate multi-radio gateways:
  ...
  2. Scan-time threat analysis  (see detect_evil_twins())
     • LA-bit rule   – BSSID with Locally Administered bit AND its OUI
                        family isn't recognized as a trusted gateway → CRITICAL
                        (siblings of a trusted family → INFO, not blocked)
